      ...
      <div class="content">
        <div class="tit">
          <el-row style="width:100%">
            <el-col :span="6"><span class="item product">商品</span></el-col>
            <el-col :span="4"><span class="item">成交单价/购买数量</span></el-col>
            <el-col :span="3"><span class="item">实付金额</span></el-col>
            <el-col :span="3"><span class="item">积分支付</span></el-col>
          ...
          <div class="prod-cont">
            <el-row style="width:100%">
              ...
              <el-col :span="3"
                    ...
                    <div class="item">
<!--                        积分支付-->
                        <div v-if="!order.actualTotal">
                            <span class="totalprice">{{(order.total +order.freightAmount)*10000}}</span>
                        </div>
                        <div v-else><span class="totalprice">{{0}}</span></div>
                    </div>
                </el-col>
              <el-col :span="3"
                      style="height: 100%;">
